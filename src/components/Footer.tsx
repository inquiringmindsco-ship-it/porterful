    ...
    return (
      <footer className="border-t border-[var(--pf-border)] bg-[var(--pf-bg-secondary)] py-8 mt-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            <h3 className="font-bold text-lg text-[var(--pf-text)]">LIKENESS™</h3>
            <p className="text-[var(--pf-text-secondary)] text-sm mt-1">
              Identity registry and signal infrastructure.
            </p>
          </div>
          <div className="flex flex-wrap gap-4 text-sm">
            <Link href="/register" className="text-[var(--pf-text-secondary)] hover:text-[var(--pf-orange)] transition-colors">
              Register
            </Link>
            <Link href="/signal" className="text-[var(--pf-text-secondary)] hover:text-[var(--pf-orange)] transition-colors">
              Signal
            </Link>
            <Link href="/dashboard" className="text-[var(--pf-text-secondary)] hover:text-[var(--pf-orange)] transition-colors">
              Dashboard
            </Link>
            <Link href="/login" className="text-[var(--pf-text-secondary)] hover:text-[var(--pf-orange)] transition-colors">
              Sign In
            </Link>
          </div>
        </div>
    ...
    <footer className="bg-[var(--pf-bg-secondary)] border-t border-[var(--pf-border)] py-12 mt-12">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-8">
          ...
          <div>
            <h3 className="font-semibold mb-4 text-[var(--pf-text)]">Shop</h3>
            <ul className="space-y-2">
              <li><Link href="/store" className="text-[var(--pf-text-secondary)] hover:text-[var(--pf-orange)] transition-colors text-sm">Store</Link></li>
              ...
              <li><Link href="/products" className="text-[var(--pf-text-secondary)] hover:text-[var(--pf-orange)] transition-colors text-sm">Products</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/dashboard/artist" className="text-[var(--pf-text-secondary)] hover:text-[var(--pf-orange)] transition-colors text-sm">My Dashboard</Link></li>
              <li><Link href="/dashboard/catalog" className="text-[var(--pf-text-secondary)] hover:text-[var(--pf-orange)] transition-colors text-sm">Choose Products</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-[var(--pf-border)] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[var(--pf-text-muted)] text-sm">
            © {new Date().getFullYear()} Porterful. The artist marketplace.
          </p>
        </div>
      </div>
    </footer>
