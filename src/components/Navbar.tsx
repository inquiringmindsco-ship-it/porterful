        ...
        <div className="pf-container">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <Link href="/apply" className="flex items-center gap-2 px-4 py-2 rounded-lg text-[var(--pf-orange)] bg-[var(--pf-orange)]/10 hover:bg-[var(--pf-orange)]/20 transition-colors font-semibold">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <Link href="/cart" className="relative hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl bg-[var(--pf-surface)] border border-[var(--pf-border)] hover:border-[var(--pf-orange)] transition-colors">
                ...
                <span className="text-[var(--pf-text-secondary)]">Cart</span>
                {itemCount > 0 && (
                  <span className="absolute -top-1 -right-1 w-5 h-5 bg-[var(--pf-orange)] text-white text-xs font-bold rounded-full flex items-center justify-center animate-pulse">
                    {itemCount > 9 ? '9+' : itemCount}
                  </span>
                )}
              </Link>
              {/* Mobile cart - icon only with badge always visible */}
      ...
      >
        <div className="p-4 space-y-2">
          ...
          <div className="pt-2 space-y-1">
            ...
            <Link href="/apply" className="flex items-center gap-3 px-4 py-4 text-[var(--pf-orange)] bg-[var(--pf-orange)]/10 font-semibold hover:bg-[var(--pf-orange)]/20 rounded-xl transition-colors" onClick={closeMobile}>
