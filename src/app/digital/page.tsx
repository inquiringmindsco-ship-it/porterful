    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Porterful - Music for Independent Artists',
      },
    ],
  },
  twitter: {
    ...
    title: 'Music | Porterful',
    description: 'Stream and buy music directly from independent artists. 80% goes to artists.',
  },
  alternates: {
    canonical: 'https://porterful.com/digital',
  },
}
            ...
            <div className="bg-gradient-to-br from-[var(--pf-orange)]/10 to-purple-600/10 rounded-xl p-4 mb-4 border border-[var(--pf-orange)]/20">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 relative">
                  <Image src={currentTrack.image || '/placeholder-album.svg'} alt={currentTrack.title} fill className="object-cover" unoptimized />
                </div>
                ...
                {filteredTracks.slice(0, 20).map(track => (
                  ...
                  >
                    <div className="w-12 h-12 rounded-lg overflow-hidden shrink-0 relative">
                      <Image src={track.image || '/placeholder-album.svg'} alt={track.title} fill className="object-cover" />
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <div key={album.id} className="flex-shrink-0 w-44">
                        ...
                        >
                          <div className="aspect-square relative">
                            <Image src={album.image || '/placeholder-album.svg'} alt={album.name} fill className="object-cover" unoptimized />
