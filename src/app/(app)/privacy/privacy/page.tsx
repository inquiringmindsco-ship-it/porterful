    ...
    <div className="min-h-screen bg-[var(--pf-bg)] text-white py-16 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-[var(--pf-text-muted)] mt-2">Last updated: March 2026</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-[var(--pf-text-secondary)] space-y-1">
          ...
          <section className="mb-8">
            ...
            <div className="bg-[var(--pf-orange)]/10 border border-[var(--pf-orange)]/30 rounded-lg p-4 mt-4">
              <p className="text-[var(--pf-orange)] font-semibold">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-[var(--pf-text-secondary)] mt-2 space-y-1">
              <li>Stripe (payments) — <a href="https://stripe.com/privacy" className="text-[var(--pf-orange)] hover:underline">Privacy Policy</a></li>
              <li>Supabase (database) — <a href="https://supabase.com/privacy" className="text-[var(--pf-orange)] hover:underline">Privacy Policy</a></li>
              <li>Vercel (hosting) — <a href="https://vercel.com/legal/privacy-policy" className="text-[var(--pf-orange)] hover:underline">Privacy Policy</a></li>
            </ul>
          </section>
