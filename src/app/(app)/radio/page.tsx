...
import { Play, Pause, SkipForward, Radio, ShoppingBag } from 'lucide-react'
...
export default function RadioPage() {
  ...
  const [shuffledTracks, setShuffledTracks] = useState<typeof TRACKS>(() =>
    shuffleArray(filterPlayableTracks(TRACKS.filter((track) => isPublicTrackArtist(track.artist))))
  )
