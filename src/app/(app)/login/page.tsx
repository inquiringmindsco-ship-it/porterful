...
export default function LoginPage() {
  ...
  const handleLikenessSignIn = async () => {
    ...
    setError('')
    try {
      // Try bridge first — validates likeness_session server-side and creates porterful_session
      ...
      // Bridge failed — user needs to go through LikenessVerified magic link
      const bridgeUrl = encodeURIComponent(encodeURIComponent(window.location.origin + '/api/auth/porterful-bridge'))
