...
const PLATFORM_ARTISTS: ArtistProfile[] = [
  ...
  // Placeholder artists - will be replaced when real artists sign up
  {
    id: 'midnight-echo',
    username: 'midnight-echo',
    full_name: 'Midnight Echo',
    email: null,
    avatar_url: null,
    bio: 'Atmospheric R&B with hints of neo-soul. Crafting soundscapes that linger.',
    genre: 'R&B / Neo-Soul',
    location: 'Atlanta, GA',
    verified: false,
    tracks: 0,
  ...
  },
  {
    ...
    email: null,
    avatar_url: null,
    bio: 'Hip-hop with old school vibes. Real bars, real stories.',
    genre: 'Hip-Hop',
    location: 'Houston, TX',
    verified: false,
    tracks: 0,
  ...
  },
  {
    id: 'nova-cross',
    username: 'nova-cross',
    full_name: 'Nova Cross',
    email: null,
    avatar_url: null,
    bio: 'Genre-defying artist blending pop, rock, and electronic.',
