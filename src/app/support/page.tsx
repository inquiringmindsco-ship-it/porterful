...
export const metadata: Metadata = {
  title: 'Support Artists Directly - Proud to Pay',
  description: 'Pay what makes sense, directly to artists. Skip streaming middlemen. $1 per song, $3.99 per album, or $5.99 for lifetime access to all music.',
  keywords: ['support artists', 'buy music directly', 'direct artist payments', 'pay artists', 'music without streaming'],
  openGraph: {
    title: 'Support Artists Directly - Porterful',
    description: 'Pay artists directly. No subscription. No streaming middleman.',
    images: ['/og-image.png'],
  },
}
