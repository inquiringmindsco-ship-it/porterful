...
export const metadata: Metadata = {
  title: 'Superfan Program - Earn While Supporting Artists',
  description: 'Become a Porterful Superfan. Earn 5% on artist merch and 3% on marketplace purchases when you share your referral code. Get paid via Stripe.',
  keywords: ['superfan', 'artist referral', 'earn money supporting artists', 'referral program', 'music fan earning'],
  openGraph: {
    title: 'Superfan Program - Porterful',
    description: 'Earn 5% on artist merch, 3% on marketplace. Share artists you love and earn.',
    images: ['/og-image.png'],
  },
}
    ...
    <div className="min-h-screen bg-[var(--pf-bg)] text-[var(--pf-text)]">
      ...
      <section className="relative overflow-hidden py-24 px-6">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-block bg-purple-500/20 text-purple-300 px-4 py-1 rounded-full text-sm font-medium mb-6">
