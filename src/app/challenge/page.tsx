        ...
        <div className="relative z-10 pf-container">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup?role=artist" className="pf-btn pf-btn-primary text-lg px-8 py-4 flex items-center justify-center gap-2">
                <Zap size={20} />
                Join the Challenge
              </Link>
              <Link href="/apply" className="pf-btn pf-btn-secondary text-lg px-8 py-4 flex items-center justify-center gap-2">
                See How It Works
                <ArrowRight size={20} />
              </Link>
            </div>
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-[var(--pf-orange)]/20 via-[var(--pf-bg)] to-purple-500/20">
        <div className="pf-container">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <Link href="/signup?role=artist" className="pf-btn pf-btn-primary text-xl px-10 py-5 inline-flex items-center gap-3">
              <Zap size={24} />
