      ...
      <div className="min-h-screen pt-24 pb-12">
        <div className="pf-container">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link href="/marketplace" className="pf-card p-6 hover:border-[var(--pf-orange)] transition-colors">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-lg bg-[var(--pf-orange)]/20 flex items-center justify-center">
          ...
          <div className="mt-8 pf-card p-6 border border-purple-500/30">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <Link href="/signup/superfan" className="pf-btn pf-btn-primary text-sm">
                  Learn More
                </Link>
              </div>
            </div>
