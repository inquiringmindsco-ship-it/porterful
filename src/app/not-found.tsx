    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--pf-bg)] px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/store" className="pf-btn pf-btn-secondary flex items-center justify-center gap-2">
            <Search size={18} />
            Browse Shop
          </Link>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-[var(--pf-border)]">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            ...
            <Link href="/store" className="text-sm text-[var(--pf-orange)] hover:underline">Merch</Link>
            <span className="text-[var(--pf-border)]">•</span>
