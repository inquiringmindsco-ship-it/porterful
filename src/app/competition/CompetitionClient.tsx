          ...
          {!isLive ? (
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                ...
                <Link href="/signup/superfan" className="px-8 py-4 bg-[var(--pf-surface)] border border-[var(--pf-border)] text-white rounded-xl font-bold text-lg hover:bg-[var(--pf-surface-hover)] transition-colors inline-flex items-center justify-center gap-2">
                  <Users size={20} />
                  Become a Superfan
                </Link>
              </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-[var(--pf-orange)] to-purple-600">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/signup/superfan" className="px-8 py-4 bg-white/10 text-white border border-white/30 rounded-xl font-bold text-lg hover:bg-white/20 transition-colors inline-flex items-center justify-center gap-2">
              <Users size={20} />
              Become a Superfan
            </Link>
          </div>
