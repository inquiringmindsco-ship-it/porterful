...
- Name: guided-tour.spec.ts >> Guided Tour — Clean Session >> Step 4 — Click Next advances to step 2
- Location: tests/e2e/guided-tour.spec.ts:64:7
...
Locator: locator('text=/Step 2 of/i')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Step 2 of/i')
