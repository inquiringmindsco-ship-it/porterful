...
- Name: guided-tour.spec.ts >> Guided Tour — Clean Session >> Step 9 — Restart Tour button present on /settings/settings
- Location: tests/e2e/guided-tour.spec.ts:159:7
...
Locator: locator('button:has-text("Restart Guided Tour")')
Expected: visible
Timeout: 5000ms
